        ...
        try {
            ...
            if (responseText.isNotBlank()) {
                ...
                if (captionTracks != null && captionTracks.length() > 0) {
                    ...
                    // التغيير هنا: جعلنا كود اللغة المصدر صغيراً (lowercase)
                    ...
                    // ب) إضافة الترجمات التلقائية (أحرف صغيرة)
                    if (baseUrl.isNotEmpty()) {
                        // القائمة أصلاً حروف صغيرة
                        ...
                        for (targetLang in autoLangs) {
                            ...
                            if (!seenSubs.contains(autoUrl)) {
                                ...
                                // التغيير هنا: التسمية بأحرف صغيرة en -> ar
...
//        com.youtube.YoutubeExtractor().getUrl(videoId, null, subtitleCallback, callback)
